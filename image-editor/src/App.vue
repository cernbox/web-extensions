...
import MediaAudio from './src/components/Sources/MediaAudio.vue'
import MediaImage from './src/components/Sources/MediaImage.vue'
import MediaVideo from './src/components/Sources/MediaVideo.vue'
import MediaSettings from './src/components/MediaSettings.vue'
import QuickCommands from './src/components/QuickCommands.vue'
import { CachedFile, AdjustmentParametersCategoryType } from './src/helpers/types'
import applyAdjustmentParams from './src/composables/saveFunctions/applyAdjustmentParams'
import { mapActions, mapGetters } from 'vuex'
import { useGettext } from 'vue3-gettext'
import { Ref } from 'vue'
import { isProjectSpaceResource } from '@ownclouders/web-client'
import { DavProperty } from '@ownclouders/web-client'
import { CropVariantEnum, ProcessingToolsEnum } from './src/helpers'
import applyCropping from './src/composables/saveFunctions/applyCropping'
...
export default defineComponent({
  ...
  setup() {
    ...
    const loadImageTask = useTask(function* () {
      ...
      const savedImageVersion = yield getFileContents(currentFileContext, {
        responseType: 'blob'
      })
